...
train_annotation_dir = ".\\data_my\\train\\labels"
val_annotation_dir = ".\\data_my\\val\\labels"
classes_label = ".\\data\\data_classes.names"
...
def change_and_create_cfg_file(classes_info, save_cfg_path="yolov3\\cfg\\my_yolov3.cfg"):
...
def main():
    ...
    create_data_data(".\\data\\voc_data.data", classes_label, train_txt_path, val_txt_path, classes_info)
